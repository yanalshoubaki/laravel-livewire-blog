                        ...
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <div class="flex max-w-lg rounded-md shadow-sm">
                                    ...
                                    <input id="username" class="flex-1 block w-full py-3 px-3 focus:outline-none border border-l-0 rounded border-gray-300 transition duration-150 ease-in-out rounded-none no-left-round form-input sm:text-sm sm:leading-5" name="username"  wire:model="user.username" spellcheck="false" data-ms-editor="true">
                        ...
                        <div class="mt-6 sm:mt-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:items-center sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div class="mt-2 sm:mt-0 sm:col-span-2">
                                <div class="flex items-center">
                                    <img id="avatar_preview" src="{{is_string($photo) ? $photo : $photo->temporaryUrl()}}" class="w-12 h-12 rounded-full">
                        ...
                        <div class="sm:grid sm:grid-cols-3 sm:gap-4 sm:items-start sm:border-t sm:border-gray-200 sm:pt-5">
                            ...
                            <div class="mt-1 sm:mt-0 sm:col-span-2">
                                <div class="max-w-xs rounded-md shadow-sm">
                                    <input id="name" name="name" wire:model="user.name" class="block w-full py-3 px-3 transition duration-150 ease-in-out form-input sm:text-sm sm:leading-5" spellcheck="false" data-ms-editor="true">
